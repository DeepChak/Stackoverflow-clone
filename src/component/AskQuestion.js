            ...
            <form onSubmit={handleSubmit}>
                <div className='ask-form-container'>
                    <label htmlFor='ask-ques-title'>
                        ...
                        placeholder='e.g. is there an R funcion for finding the index of an element in a vector?'></input>
                    </label>
                ...
                <label htmlFor='ask-ques-tags'>
                        <h4>Tags</h4>
                        <p>Add upto 5 tags to describe what your question is about. Start typing to see suggestion</p>
